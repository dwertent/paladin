...
See the [tutorial](https://LFDT-Paladin.github.io/paladin/head/tutorials/private-stablecoin/) for a detailed explanation.
...
npm install @lfdecentralizedtrust/paladin-sdk@latest
